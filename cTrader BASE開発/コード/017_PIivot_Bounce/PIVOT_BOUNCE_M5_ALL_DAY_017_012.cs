...
// ============================================================
// BASE: PIVOT_BOUNCE_M5_ALL_DAY_017_011
// THIS: PIVOT_BOUNCE_M5_ALL_DAY_017_012
// ============================================================
...
namespace cAlgo
{
    ...
    public class HIVE_PivotBounce_v0_1_7 : Robot
    {
        ...
        // BASE: PIVOT_BOUNCE_M5_ALL_DAY_017_011
        // THIS: PIVOT_BOUNCE_M5_ALL_DAY_017_012
        private const string CODE_NAME = "PIVOT_BOUNCE_M5_ALL_DAY_017_012";
        private const string BOT_LABEL = "PIVOT_BOUNCE_v0_1_7_012";
        // ============================================================
...
";
        ...
        private bool OutsideModeAllowsEntry(TradeType intended)
        {
            ...
            // Rule: once outside S3/R3, allow only countertrend entries
            // Below S3 -> allow Buy only; Above R3 -> allow Sell only
            if (_outsideMode == OutsideS3R3Mode.BelowS3)
                return intended == TradeType.Buy;

            if (_outsideMode == OutsideS3R3Mode.AboveR3)
