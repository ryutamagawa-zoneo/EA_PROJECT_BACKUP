...
// THIS: PIVOT_BOUNCE_M5_ALL_DAY_017_001
// ============================================================
...
namespace cAlgo
{
    ...
    public class HIVE_PivotBounce_v0_1_7 : Robot
    {
        ...
        // BASE: PIVOT_BOUNCE_M5_ALL_DAY_016_011
        // THIS: PIVOT_BOUNCE_M5_ALL_DAY_017_001
        private const string CODE_NAME = "PIVOT_BOUNCE_M5_ALL_DAY_017_001";
...
";
        ...
        private void TryPivotBounceEntry_LatestTouchOnly()
        {
            ...
            if (IsSupportLine(_lastTouchedLine))
            {
                ...
                // Min RR filter (apply before distance staging; if fails, do not set pending)
                double rr;
                ...
                // Entry distance gate: if too far, set pending instead of hard-skip
        ...
        private bool ProcessPendingReapproachIfAny()
        {
            ...
            // If latest touch line changed, invalidate pending
            ...
            // Direction filter must still allow
            ...
            // TP validity must still be forward
            ...
            // Min RR filter at trigger time (do not execute if RR is below threshold)
            double rr;
        ...
        private bool TryResolveTpTarget(PivotLine entryLine, TradeType type, out double tpTargetPrice, out string tpLineName)
        {
            ...
            // MODIFY-3 (016_010 base behavior): PP is entry-eligible and TP is explicit
