...
// ============================================================
// BASE: PIVOT_BOUNCE_M5_ALL_DAY_017_004
// THIS: PIVOT_BOUNCE_M5_ALL_DAY_017_005
// ============================================================
...
namespace cAlgo
{
    ...
    public class HIVE_PivotBounce_v0_1_7 : Robot
    {
        ...
        // BASE: PIVOT_BOUNCE_M5_ALL_DAY_017_004
        // THIS: PIVOT_BOUNCE_M5_ALL_DAY_017_005
        private const string CODE_NAME = "PIVOT_BOUNCE_M5_ALL_DAY_017_005";
        ...
        // ADD(017_005): Hysteresis ratio (EXIT/ENTER)
...
";
            ...
            Print(
                ...
                "MinHoldMin={15} | MinTP(PIPS)={16} | DirDeadzone(PIPS)={17} | DirHystRatio={18} | " +
                "EntryMaxDist(PIPS)={19} | ReapproachWinBars={20} | ReapproachMaxDist(PIPS)={21} | " +
                "TouchExpireBars={22} | MaxTouchRange(PIPS)={23} | PivotRollover(NY)=17:00(FIXED) | StopOnInvalidPivot={24} | MaxPivotMissing={25} | MinRR={26}",
                CODE_NAME,
                BOT_LABEL,
                SymbolName,
                TradeStartTimeJst,
