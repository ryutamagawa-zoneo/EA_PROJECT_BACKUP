...
// THIS: EMA_M5_ALL_DAY_020_068_XAUUSD_M5
...
namespace cAlgo
{
    ...
    public class EMA_M5_ALL_DAY_020_068_XAUUSD_M5 : Robot
    {
        // ============================================================
        // CODE NAME (Project Constitution compliant)
        // ============================================================
        // BASE: EMA_M5_ALL_DAY_020_047_XAUUSD_M5
        // THIS: EMA_M5_ALL_DAY_020_068_XAUUSD_M5
        private const string CODE_NAME = "EMA_M5_ALL_DAY_020_068_XAUUSD_M5";
...
private void EmitExecuteSendJsonl(TradeType plannedType, int barIndex, long volumeUnits, double slPipsToSend, double tpPipsToSend)
        ...
        // {"event":"EA_INIT","code_name":"EMA_M5_ALL_DAY_020_068_XAUUSD_M5","run_id":"20260210_120000_000","symbol_raw":"XAUUSD","symbol_norm":"XAUUSD","timeframe":"Minute5","flags":{"EnableProReport":true},"params":{"RiskPercent":"0.50"}}
        // {"event":"BAR_CLOSE","code_name":"EMA_M5_ALL_DAY_020_068_XAUUSD_M5","run_id":"20260210_120000_000","symbol_norm":"XAUUSD","timeframe":"Minute5","bar_index":1234,"bar_time_utc_ms":1739145600000,"open":2910.1,"high":2912.4,"low":2909.8,"close":2911.6,"spread":2.1}
        // {"event":"EXECUTE_SKIP","code_name":"EMA_M5_ALL_DAY_020_068_XAUUSD_M5","run_id":"20260210_120000_000","symbol_norm":"XAUUSD","timeframe":"Minute5","bar_time_utc_ms":1739145600000,"plannedType":"Buy","reason":"SPREAD_BLOCK","close1":2911.6,"ema1":2911.2,"spread":3.4}
        // {"event":"EXECUTE_SEND","code_name":"EMA_M5_ALL_DAY_020_068_XAUUSD_M5","run_id":"20260210_120000_000","symbol_norm":"XAUUSD","timeframe":"Minute5","bar_time_utc_ms":1739145600000,"plannedType":"Buy","volumeUnits":1000,"slPipsToSend":35.0,"tpPipsToSend":35.0}
        // {"event":"EXECUTE_RESULT","code_name":"EMA_M5_ALL_DAY_020_068_XAUUSD_M5","run_id":"20260210_120000_000","symbol_norm":"XAUUSD","timeframe":"Minute5","bar_time_utc_ms":1739145600000,"plannedType":"Buy","success":true,"positionId":12345678,"error":null}
...
";
                ...
                private string ResolveProOutputDirectory()
        {
            ...
            // フォルダ名：{コード番号}_{時刻(HHmmss)}  ※Windows不可文字「:」は使用しない
            ...
            try
            {
                ...
                string hhmmss = ToJst(DateTime.UtcNow).ToString("HHmmss", CultureInfo.InvariantCulture);
                string sub = tag + "_" + hhmmss;
