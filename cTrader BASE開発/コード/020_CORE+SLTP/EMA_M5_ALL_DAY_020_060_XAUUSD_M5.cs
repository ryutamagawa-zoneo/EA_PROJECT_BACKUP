...
// THIS: EMA_M5_ALL_DAY_020_060_XAUUSD_M5
...
namespace cAlgo
{
    ...
    public class EMA_M5_ALL_DAY_020_058_XAUUSD_M5 : Robot
    {
        // ============================================================
        // CODE NAME (Project Constitution compliant)
        // ============================================================
        // BASE: EMA_M5_ALL_DAY_020_047_XAUUSD_M5
        // THIS: EMA_M5_ALL_DAY_020_060_XAUUSD_M5
        private const string CODE_NAME = "EMA_M5_ALL_DAY_020_057_XAUUSD_M5";
        ...
        private void InitializeEntryDecisionLogging()
        {
            ...
            _entryDecisionJsonlPath = Path.Combine(ENTRY_DECISION_FIXED_DIR, "cTrader_ENTRY_DECISION_058_" + stamp + ".jsonl");
            _pendingStateJsonlPath = Path.Combine(ENTRY_DECISION_FIXED_DIR, "cTrader_PENDING_STATE_058_" + stamp + ".jsonl");
