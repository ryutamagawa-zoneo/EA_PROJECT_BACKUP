...
// THIS: EMA_M5_ALL_DAY_020_030_XAUUSD_M5
...
namespace cAlgo
{
    ...
    public class EA_DEV_FIRST : Robot
    {
        ...
        // BASE: EMA_M5_ALL_DAY_019_048_XAUUSD_M5
        // THIS: EMA_M5_ALL_DAY_020_030_XAUUSD_M5
        private const string CODE_NAME = "EMA_M5_ALL_DAY_020_030_XAUUSD_M5";
        private const string BOT_LABEL = "EMA_M5_ALL_DAY_020_030_XAUUSD_M5";
        ...
        private void ApplyBreakevenMoveIfNeeded()
        {
            ...
            for (int i = Positions.Count - 1; i >= 0; i--)
            {
                ...
                if (p.TradeType == TradeType.Buy)
                {
                    ...
                    bool modified = false; // 030 policy: SL must never move (BreakEven disabled)
                    if (EnableDebugLogJst)
                    {
