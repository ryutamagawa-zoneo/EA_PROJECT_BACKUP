...
// ============================================================
// BASE: EMA_M5_ALL_DAY_019_025_XAUUSD_M5
// THIS: EMA_M5_ALL_DAY_019_026_XAUUSD_M5
// ARCHIVE_ID: 019_026 (file export marker; no runtime effect)
// ============================================================
...
namespace cAlgo
{
    ...
    public class EA_DEV_FIRST : Robot
    {
        ...
        // BASE: EMA_M5_ALL_DAY_019_025_XAUUSD_M5
        // THIS: EMA_M5_ALL_DAY_019_026_XAUUSD_M5
        private const string CODE_NAME = "EMA_M5_ALL_DAY_019_026_XAUUSD_M5";
        private const string BOT_LABEL = "EMA_M5_ALL_DAY_019_026_XAUUSD_M5";
...
private sealed class ParamSnapshotEntry
{
    ...
    public string ValueText { get; set; }
        ...
        [Parameter("001MODE（はい ・ いいえ）", Group = "001制御・エントリー", DefaultValue = true)]
        ...
        [Parameter("エントリーモード（001・EMA）", Group = "001制御・エントリー", DefaultValue = エントリーモード._001)]
        ...
        [Parameter("構造SLが見つからない場合はエントリーしない（はい・いいえ）", Group = "SL関連・構造SL", DefaultValue = true)]
        ...
        [Parameter("構造TPブースト１（はい・いいえ）", Group = "TP関連・構造ブースト", DefaultValue = false)]
        ...
        [Parameter("構造TP第2段ブースト２（はい・いいえ）", Group = "TP関連・構造ブースト", DefaultValue = true)]
        ...
        [Parameter("スイング割れ判定終値確定（はい・いいえ）", Group = "TP関連・ブースト２出口", DefaultValue = true)]
        ...
        [Parameter("EMA方向フィルター（はい・いいえ）", Group = "方向・判定補助", DefaultValue = false)]
        ...
        [Parameter("バックテスト用（はい・いいえ）", Group = "経済指標フィルター（UTC）", DefaultValue = false)]
