...
// THIS: EMA_M5_ALL_DAY_019_039_XAUUSD_M5
...
namespace cAlgo
{
    ...
    public class EA_DEV_FIRST : Robot
    {
        ...
        // BASE: EMA_M5_ALL_DAY_019_029_XAUUSD_M5
        // THIS: EMA_M5_ALL_DAY_019_039_XAUUSD_M5
        private const string CODE_NAME = "EMA_M5_ALL_DAY_019_039_XAUUSD_M5";
        private const string BOT_LABEL = "EMA_M5_ALL_DAY_019_039_XAUUSD_M5";
        ...
        || (Enable001EntrySuppressionStructure
            ...
            if (Is001ModeEnabled() && IsEntryMode001())
            {
        ...
        // ============================================================
        // 001MODE: 有効判定ユーティリティ（統一ゲート）
        // ============================================================
        private bool Is001ModeEnabled()
        {
            // 001MODEは「明示的にMode001を選択し、かつEnable001ModeがON」のときのみ有効
            if (EntryMode != エントリーモード.Mode001)
                return false;
        ...
        // ============================================================
        // 互換（過去差分で参照された名称の救済）
        // - is001Enabled / is001ModeEnabled の参照が残っていてもビルドを落とさない
        // ============================================================
        private bool is001Enabled => Is001ModeEnabled();
        private bool is001ModeEnabled => Is001ModeEnabled();
