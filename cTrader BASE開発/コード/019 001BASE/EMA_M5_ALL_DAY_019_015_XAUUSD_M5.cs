...
// ============================================================
// BASE: EMA_M5_ALL_DAY_019_014_XAUUSD_M5
// THIS: EMA_M5_ALL_DAY_019_015_XAUUSD_M5
// ARCHIVE_ID: 019_015 (file export marker; no runtime effect)
// ============================================================
...
namespace cAlgo
{
    ...
    public class EA_DEV_FIRST : Robot
    {
        ...
        // BASE: EMA_M5_ALL_DAY_019_014_XAUUSD_M5
        // THIS: EMA_M5_ALL_DAY_019_015_XAUUSD_M5
        private const string CODE_NAME = "EMA_M5_ALL_DAY_019_015_XAUUSD_M5";
        private const string BOT_LABEL = "EMA_M5_ALL_DAY_019_015_XAUUSD_M5";
            ...
            foreach (var p in Positions)
            {
                ...
                if (!stage1Active)
                {
                    ...
                    if (modified)
                    {
                        ...
                        Print("STRUCTURE_TP_STAGE1_ACTIVATED | CodeName={0} | Label={1} | Symbol={2} | Type={3} | Trigger=UnrealizedR>={4} | UnrealizedR={5} | TpAbs={6}{7}",
                            CODE_NAME,
                            BOT_LABEL,
                            SymbolName,
                            p.TradeType,
                ...
                if (!stage2Active)
                {
                    ...
                    if (modified2)
                    {
                        ...
                        Print("STRUCTURE_TP_STAGE2_ACTIVATED | CodeName={0} | Label={1} | Symbol={2} | Type={3} | Trigger=UnrealizedR>={4} | UnrealizedR={5} | TpAbs={6}{7}",
                            CODE_NAME,
                            BOT_LABEL,
                            SymbolName,
                            p.TradeType,
                            ...
                            unrealizedR.ToString("F2", CultureInfo.InvariantCulture),
                            tpAbs2.ToString("F5", CultureInfo.InvariantCulture),
                            BuildTimeTag(UtcNow()));
                    }
                }
            }
