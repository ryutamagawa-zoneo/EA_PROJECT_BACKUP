...
// THIS: EMA_M5_ALL_DAY_019_007_XAUUSD_M5
// ARCHIVE_ID: 019_007 (file export marker; no runtime effect)
// ============================================================
...
namespace cAlgo
{
    ...
    public class EA_DEV_FIRST : Robot
    {
        ...
        // BASE: EMA_M5_ALL_DAY_019_004_XAUUSD_M5
        // THIS: EMA_M5_ALL_DAY_019_007_XAUUSD_M5
        private const string CODE_NAME = "EMA_M5_ALL_DAY_019_007_XAUUSD_M5";
        private const string BOT_LABEL = "EMA_M5_ALL_DAY_019_007_XAUUSD_M5";
...
{
    // ForceFlat / ForceClose を優先（評価基盤：CloseReasonの正規化）
    if (!string.IsNullOrWhiteSpace(initiator) && initiator.StartsWith("FORCE_CLOSE:", StringComparison.Ordinal))
    {
        ...
        if (string.Equals(r, "FORCE_FLAT", StringComparison.Ordinal))
            return "ForceFlat";
        return "ForceClose";
    }
