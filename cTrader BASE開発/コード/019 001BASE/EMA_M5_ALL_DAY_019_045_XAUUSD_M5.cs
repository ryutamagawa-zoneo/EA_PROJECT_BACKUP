...
namespace cAlgo
{
    ...
    public class EA_DEV_FIRST : Robot
    {
        ...
        private void TryEntryFrameworkSignalWithParamExit(DateTime utcNow)
        {
            ...
            // 入口の判定ログ（比較用）
            Print("CORE_TEST_ENTRY_SIGNAL | Mode=Framework | Type={0} | Reason={1} | Close2={2} EMA2={3} | Close1={4} EMA1={5}{6}",
                type,
            ...
            // 出口（SL/TP）はパラメーター世界へ
            ExecuteEntryWithPlannedType(type, "FRAMEWORK_EMA_CROSS", utcNow);
        }
