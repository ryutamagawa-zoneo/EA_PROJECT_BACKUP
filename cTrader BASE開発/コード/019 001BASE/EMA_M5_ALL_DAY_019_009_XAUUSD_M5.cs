...
// ============================================================
// BASE: EMA_M5_ALL_DAY_019_008_XAUUSD_M5
// THIS: EMA_M5_ALL_DAY_019_009_XAUUSD_M5
// ARCHIVE_ID: 019_009 (file export marker; no runtime effect)
// ============================================================
...
// BASE: EMA_M5_ALL_DAY_019_008_XAUUSD_M5
        // THIS: EMA_M5_ALL_DAY_019_009_XAUUSD_M5
        private const string CODE_NAME = "EMA_M5_ALL_DAY_019_009_XAUUSD_M5";
        private const string BOT_LABEL = "EMA_M5_ALL_DAY_019_009_XAUUSD_M5";
...
public double FixedTpPips { get; set; }
        ...
        private bool _lastTradePermission = true;
        private string _lastTradeStopReason = "";
        private DateTime? _lastTradeStopUntil = null;
...
try
{
    Positions.Closed -= OnPositionsClosedForProReport;
        ...
        protected override void OnTimer()
        {
            ...
            // 市場追従（早期閉場含む）による強制決済は CloseReason=MarketClose
            CloseAllPositionsForSymbol("MARKET_CLOSE");
}
