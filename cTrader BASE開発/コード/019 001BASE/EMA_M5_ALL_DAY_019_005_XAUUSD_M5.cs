...
// THIS: EMA_M5_ALL_DAY_019_005_XAUUSD_M5
// ARCHIVE_ID: 019_005 (file export marker; no runtime effect)
// ============================================================
...
namespace cAlgo
{
    ...
    public class EA_DEV_FIRST : Robot
    {
        ...
        // BASE: EMA_M5_ALL_DAY_019_004_XAUUSD_M5
        // THIS: EMA_M5_ALL_DAY_019_005_XAUUSD_M5
        private const string CODE_NAME = "EMA_M5_ALL_DAY_019_005_XAUUSD_M5";
        private const string BOT_LABEL = "EMA_M5_ALL_DAY_019_005_XAUUSD_M5";
...
";
        ...
        private void PrintCloseCore(Position pos, string closeReason)
        {
            try
            {
                ...
                Print(
                    "CLOSE_CORE | CodeName={0} | PosId={1} | CloseReason={2} | Sym={3} | SL={4} | TP={5}{6}",
                    CODE_NAME,
                    pos.Id,
