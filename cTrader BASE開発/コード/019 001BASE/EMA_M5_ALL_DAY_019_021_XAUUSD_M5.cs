...
// THIS: EMA_M5_ALL_DAY_019_021_XAUUSD_M5
// ARCHIVE_ID: 019_021 (file export marker; no runtime effect)
// ============================================================
...
namespace cAlgo
{
    ...
    public class EA_DEV_FIRST : Robot
    {
        ...
        private const string CODE_NAME = "EMA_M5_ALL_DAY_019_021_XAUUSD_M5";
        private const string BOT_LABEL = "EMA_M5_ALL_DAY_019_021_XAUUSD_M5";
        ...
        [Parameter("Stage2出口（フラクタル）左右本数（M15）", Group = "TP関連 - Stage2出口", DefaultValue = 2, MinValue = 1)]
        public int Stage2ExitFractalLR { get; set; }

        [Parameter("Stage2出口（スイング割れ判定）終値確定（はい・いいえ）", Group = "TP関連 - Stage2出口", DefaultValue = true)]
