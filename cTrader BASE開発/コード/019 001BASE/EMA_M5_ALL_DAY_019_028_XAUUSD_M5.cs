...
// ============================================================
// BASE: EMA_M5_ALL_DAY_019_026_XAUUSD_M5
// THIS: EMA_M5_ALL_DAY_019_028_XAUUSD_M5
// ARCHIVE_ID: 019_028 (file export marker; no runtime effect)
// ============================================================
...
namespace cAlgo
{
    ...
    public class EA_DEV_FIRST : Robot
    {
        ...
        // THIS: EMA_M5_ALL_DAY_019_028_XAUUSD_M5
        private const string CODE_NAME = "EMA_M5_ALL_DAY_019_028_XAUUSD_M5";
        private const string BOT_LABEL = "EMA_M5_ALL_DAY_019_028_XAUUSD_M5";
...
private sealed class ParamSnapshotEntry
{
    ...
    public string ValueText { get; set; }
        ...
        [Parameter("エントリーモード（001・EMA）", Group = "001制御・エントリー", DefaultValue = "001")]
        public string EntryMode { get; set; }

        private bool IsEntryMode001()
        {
            // UI表示要件: 選択肢を「001 / EMA」とするため、文字列で保持する
            // 旧保存値の互換: "_001" も受け入れる
            var v = (EntryMode ?? string.Empty).Trim();
            if (string.Equals(v, "001", StringComparison.OrdinalIgnoreCase)) return true;
            if (string.Equals(v, "_001", StringComparison.OrdinalIgnoreCase)) return true;
            return false;
        }
        ...
        {
            var v = (EntryMode ?? string.Empty).Trim();
            if (string.Equals(v, "EMA", StringComparison.OrdinalIgnoreCase)) return true;
            return false;
        }
