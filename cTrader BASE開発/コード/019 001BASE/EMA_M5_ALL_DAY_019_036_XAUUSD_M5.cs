...
// THIS: EMA_M5_ALL_DAY_019_036_XAUUSD_M5
...
namespace cAlgo
{
    ...
    public class EA_DEV_FIRST : Robot
    {
        ...
        // BASE: EMA_M5_ALL_DAY_019_029_XAUUSD_M5
        // THIS: EMA_M5_ALL_DAY_019_036_XAUUSD_M5
        private const string CODE_NAME = "EMA_M5_ALL_DAY_019_036_XAUUSD_M5";
        private const string BOT_LABEL = "EMA_M5_ALL_DAY_019_036_XAUUSD_M5";
        ...
        private void ExecuteEntryWithPlannedType(TradeType plannedType, string reasonTag, double close1, double ema1, int i1)
        {
            ...
            if (SlMode != SL方式.構造 || intendedSlDistancePrice <= 0.0)
            {
                ...
                if (SlMode == SL方式.固定)
                {
                    ...
                    baseDistancePrice = PipsToPrice(Math.Max(0.0, FixedSLPips));
                }
