...
// THIS: EMA_M5_ALL_DAY_018_022_XAUUSD_M5
// ARCHIVE_ID: 022 (file export marker; no runtime effect)
// ============================================================
...
namespace cAlgo
{
    ...
    public class EA_DEV_FIRST : Robot
    {
        ...
        // BASE: EMA_M5_ALL_DAY_018_021_XAUUSD_M5
        // THIS: EMA_M5_ALL_DAY_018_022_XAUUSD_M5
        private const string CODE_NAME = "EMA_M5_ALL_DAY_018_022_XAUUSD_M5";
        private const string BOT_LABEL = "EMA_M5_ALL_DAY_018_022_XAUUSD_M5";
        // ============================================================
        ...
        private void PlaceTrade(TradeType type, double entry, double stop, double tpTargetPrice, string reasonTag)
        {
            ...
            for (int attempt = 0; attempt < maxAttempts; attempt++)
            {
                ...
                double expRr = (effectiveSlPips > 0.0) ? (tpPipsFromTarget / effectiveSlPips) : 0.0;
