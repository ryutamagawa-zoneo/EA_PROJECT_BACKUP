...
// ============================================================
// BASE: EMA_M5_ALL_DAY_018_024_XAUUSD_M5
// THIS: EMA_M5_ALL_DAY_018_026_XAUUSD_M5
// ARCHIVE_ID: 026 (file export marker; no runtime effect)
// ============================================================
...
namespace cAlgo
{
    ...
    public class EA_DEV_FIRST : Robot
    {
        ...
        // THIS: EMA_M5_ALL_DAY_018_026_XAUUSD_M5
        private const string CODE_NAME = "EMA_M5_ALL_DAY_018_026_XAUUSD_M5";
        private const string BOT_LABEL = "EMA_M5_ALL_DAY_018_026_XAUUSD_M5";
        // ============================================================
...
[Parameter("緊急クローズ倍率", Group = "資金管理・ロット制御", DefaultValue = 1.2, MinValue = 1.0)]
        ...
        [Parameter("傾き判定本数", Group = "方向フィルタ", DefaultValue = 3, MinValue = 1)]
        ...
        protected override void OnStart()
        {
            ...
            // 方向判定（上位足EMA傾き）
            _dirBars = MarketData.GetBars(DirectionTimeFrame);
            _dirEma = Indicators.ExponentialMovingAverage(_dirBars.ClosePrices, Math.Max(1, DirectionEmaPeriod));
        ...
        private Regime GetRegime()
        {
            ...
            if (_dirBars == null || _dirEma == null || _dirEma.Result == null)
                return Regime.Neutral;

            int last = _dirBars.Count - 1;
            ...
            for (int i = 0; i < n; i++)
            {
                double cur = _dirEma.Result[last - i];
                double prev = _dirEma.Result[last - i - 1];
