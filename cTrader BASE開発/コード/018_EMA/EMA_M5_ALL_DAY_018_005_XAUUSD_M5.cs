...
// ============================================================
// BASE: EMA_M5_ALL_DAY_018_004_XAUUSD_M5
// THIS: EMA_M5_ALL_DAY_018_005_XAUUSD_M5
// ARCHIVE_ID: 005 (file export marker; no runtime effect)
// ============================================================
...
namespace cAlgo
{
    ...
    public class EA_DEV_FIRST : Robot
    {
        ...
        // BASE: EMA_M5_ALL_DAY_018_004_XAUUSD_M5
        // THIS: EMA_M5_ALL_DAY_018_005_XAUUSD_M5
        private const string CODE_NAME = "EMA_M5_ALL_DAY_018_005_XAUUSD_M5";
        private const string BOT_LABEL = "EMA_M5_ALL_DAY_018_005_XAUUSD_M5";
        // ============================================================
        ...
        [Parameter("１トレードのリスク（%）（残高基準）", Group = "資金管理・ロット制御", DefaultValue = 0.0, MinValue = 0.0, MaxValue = 100.0)]
        public double RiskPercentOfBalance { get; set; }
...
";
        ...
        protected override void OnStart()
        {
            ...
            Print(
                ...
                RiskPercentOfBalance.ToString("F2", CultureInfo.InvariantCulture),
        ...
        private void ValidateRiskInputsOrStop()
        {
            ...
            double pct = Math.Max(0.0, RiskPercentOfBalance);
        ...
        private void PlaceTrade(TradeType type, double entry, double stop, double tpTargetPrice, string reasonTag)
        {
            ...
            for (int attempt = 0; attempt < maxAttempts; attempt++)
            {
                ...
                Print(
                    ...
                    mode,
                    (mode == RiskMode.Percent ? RiskPercentOfBalance.ToString("F2", CultureInfo.InvariantCulture) : RiskDollars.ToString("F2", CultureInfo.InvariantCulture)),
                    AccountCurrency,
