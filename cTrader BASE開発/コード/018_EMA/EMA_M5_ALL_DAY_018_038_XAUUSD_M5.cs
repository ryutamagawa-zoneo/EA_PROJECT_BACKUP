...
// THIS: EMA_M5_ALL_DAY_018_038_XAUUSD_M5
// ARCHIVE_ID: 038 (file export marker; no runtime effect)
// ============================================================
...
namespace cAlgo
{
    ...
    public class EA_DEV_FIRST : Robot
    {
        ...
        private const string CODE_NAME = "EMA_M5_ALL_DAY_018_038_XAUUSD_M5";
        private const string BOT_LABEL = "EMA_M5_ALL_DAY_018_038_XAUUSD_M5";
...
private void ExportProReportHtml()
{
    ...
    var dir = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments), "cTrader", "Reports");
    try
    {
