...
// ============================================================
// BASE: EMA_M5_ALL_DAY_018_035_XAUUSD_M5
// THIS: EMA_M5_ALL_DAY_018_036_XAUUSD_M5
// ARCHIVE_ID: 036 (file export marker; no runtime effect)
// ============================================================
...
namespace cAlgo
{
    ...
    public class EA_DEV_FIRST : Robot
    {
        ...
        private const string CODE_NAME = "EMA_M5_ALL_DAY_018_036_XAUUSD_M5";
        private const string BOT_LABEL = "EMA_M5_ALL_DAY_018_036_XAUUSD_M5";
...
private bool TryConsume001ModeReapproachSignal(int signalIndex, double close, double ema, out TradeType intended, out string reasonTag)
{
    ...
    return true;
        ...
        private void TryEntryFramework001(DateTime utcNow)
        {
            ...
            {
                Print(
                    "EMA_PACKET | CodeName={0} | Symbol={1} | UtcNow={2:o} | Type={3} | Entry={4} | Stop={5} | SlPips={6:F2} | TP={7} | TpPips={8:F2} | RR={9:F2} | ATR={10} | Risk={11}{12}",
                    CODE_NAME,
                    SymbolName,
                    DateTime.SpecifyKind(utcNow, DateTimeKind.Utc),
                    type,
            ...
            double sizingPips = slInternalPips + bufferInternalPips + slipInternalPips;
            if (sizingPips <= 0.0)
                return;
