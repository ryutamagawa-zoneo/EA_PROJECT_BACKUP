...
// THIS: EMA_M5_ALL_DAY_018_009_XAUUSD_M5
// ARCHIVE_ID: 009 (file export marker; no runtime effect)
// ============================================================
...
namespace cAlgo
{
    ...
    public class EA_DEV_FIRST : Robot
    {
        ...
        // BASE: EMA_M5_ALL_DAY_018_008_XAUUSD_M5
        // THIS: EMA_M5_ALL_DAY_018_009_XAUUSD_M5
        private const string CODE_NAME = "EMA_M5_ALL_DAY_018_009_XAUUSD_M5";
        private const string BOT_LABEL = "EMA_M5_ALL_DAY_018_009_XAUUSD_M5";
        // ============================================================
...
[Parameter("緊急クローズ倍率", Group = "資金管理・ロット制御", DefaultValue = 1.2, MinValue = 1.0)]
        ...
        [Parameter("SL方式（固定/ATR/構造）", Group = "ストップロス関連", DefaultValue = SL方式.構造)]
        ...
        // --- Compatibility alias: some older blocks referenced DebugMode
        //     Keep for compile-safety; it maps to デバッグON（UTC/JST併記）
        private bool DebugMode => EnableDebugLogJst;
...
";
        ...
        protected override void OnStart()
        {
            ...
            Print(
                ...
                "News={19} Before={20} After={21} | SpreadMax(PIPS)={22}{23} | Mode={24} PipsScale={25} SlipAllow={26} SlipAllowInt={27}",
                CODE_NAME,
                BOT_LABEL,
                SymbolName,
        ...
        private void TryEmaEntry()
        {
            ...
            if (SlMode == SL方式.構造)
            {
                ...
                else
                {
                    ...
                    // tpDistance計算の基準距離として intendedSlDistancePrice を使用
                }
            }
            ...
            double tpDistance = intendedSlDistancePrice * rr;
