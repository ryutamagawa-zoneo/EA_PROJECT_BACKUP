...
private DateTime? ComputeNewsUnblockUtc(DateTime utcNow)
{
    ...
    return null;
        ...
        private const string HL_LegacyDrawObjectPrefix = "EA_HL_010_";
        private const string HL_LegacyFallbackPrefix = "HL_";
...
";
        ...
        private void HL_Fibo_OnBar_F1(DateTime utcNow)
        {
        ...
        private bool HL_IsDrawObjectTargetName(string name)
        {
            ...
            if (name.StartsWith(HL_LegacyFallbackPrefix, StringComparison.Ordinal))
                return true;

            return name.StartsWith(HL_LegacyDrawObjectPrefix, StringComparison.Ordinal) &&
                   name.IndexOf(".HL.", StringComparison.Ordinal) >= 0;
        }
