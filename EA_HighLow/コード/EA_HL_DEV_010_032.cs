...
namespace cAlgo
{
    ...
    public class EA_HL_DEV_010_032 : Robot
    {
        // ============================================================
        // CODE NAME (Project Constitution compliant)
        // ============================================================
        ...
        // THIS: EA_HL_DEV_010_032
        // REASON: Envトレンド（UP/DOWN/TRENDLESS）による方向ゲートを全エントリー共通の最終発注直前に適用し、逆方向の新規エントリーを抑止するため
        private const string CODE_NAME = "EA_HL_DEV_010_032";
...
private DateTime? ComputeNewsUnblockUtc(DateTime utcNow)
{
    ...
    return null;
        ...
        private const string HL_OldDrawObjectPrefix_010_030 = "EA_HL_DEV_010_030.";
        private static readonly string[] HL_OldDrawObjectPrefixes = new[] { HL_OldDrawObjectPrefix_010_031, HL_OldDrawObjectPrefix_010_030 };
