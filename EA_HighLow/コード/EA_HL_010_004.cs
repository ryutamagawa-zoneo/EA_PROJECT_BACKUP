...
";
        ...
        private void HL_RedrawPivots()
        {
            ...
            BeginInvokeOnMainThread(() =>
            {
                ...
                if (_m5Pivots != null && _m5Pivots.Count >= 2)
                    HL_DrawSeries("M5", _m5Pivots, Color.Red);

                if (_h1Projected != null && _h1Projected.Count >= 2)
                    HL_DrawSeries("H1", _h1Projected, Color.White);
            });
        }
        ...
        private void HL_ClearDrawings()
        {
            ...
            for (int i = 0; i < _hlDrawNames.Count; i++)
            {
                try
                {
                    Chart.RemoveObject(_hlDrawNames[i]);
                }
                catch
                {
                }
        ...
        private int HL_ForceCleanDrawingsByPrefix()
        {
            if (Chart == null)
                return 0;
            ...
            for (int i = 0; i < names.Count; i++)
            {
                ...
                try
                {
                    ...
                    if (HL_ログ毎バー出す && loggedNameCount < HL_ForceCleanLogNameLimit)
                    {
            ...
            if (HL_ログ毎バー出す)
                Print("HL_FORCE_CLEAN | Removed={0}", removedCount);
