...
// ============================================================
// BASE: EA_HL_010_006
// THIS: EA_HL_DEV_010_033
// ARCHIVE_ID: 020_053 (file export marker; no runtime effect)
// REASON: Envトレンド（UP/DOWN/TRENDLESS）による方向ゲートを全エントリー共通の最終発注直前に適用し、逆方向の新規エントリーを抑止するため
// ============================================================
...
namespace cAlgo
{
    ...
    public class EA_HL_DEV_010_033 : Robot
    {
        // ============================================================
        // CODE NAME (Project Constitution compliant)
        // ============================================================
        ...
        // THIS: EA_HL_DEV_010_033
        // REASON: Envトレンド（UP/DOWN/TRENDLESS）による方向ゲートを全エントリー共通の最終発注直前に適用し、逆方向の新規エントリーを抑止するため
        private const string CODE_NAME = "EA_HL_DEV_010_033";
...
private DateTime? ComputeNewsUnblockUtc(DateTime utcNow)
{
    ...
    return null;
        ...
        private const string HL_OldDrawObjectPrefix_010_031 = "EA_HL_DEV_010_031.";
        private static readonly string[] HL_OldDrawObjectPrefixes = new[] { HL_OldDrawObjectPrefix_010_032, HL_OldDrawObjectPrefix_010_031 };
...
";
        ...
        private bool CanEnterByEnvEntryTrend(TradeType plannedType, out string denyReason)
        {
            ...
            {
                if (環境足トレンドレス時 == 環境足トレンドレス時_許可設定.許可)
                    return true;
