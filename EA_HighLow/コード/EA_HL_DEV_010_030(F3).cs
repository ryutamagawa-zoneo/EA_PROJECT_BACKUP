...
// ============================================================
// BASE: EA_HL_010_006
// THIS: EA_HL_DEV_010_030
// ARCHIVE_ID: 020_053 (file export marker; no runtime effect)
// REASON: HL_DOW転換構造型（Down終了→HL→TriggerHigh）に沿って判定再置換（モード切替復旧）
// ============================================================
...
namespace cAlgo
{
    ...
    public class EA_HL_DEV_010_030 : Robot
    {
        // ============================================================
        // CODE NAME (Project Constitution compliant)
        // ============================================================
        ...
        // THIS: EA_HL_DEV_010_030
        // REASON: HL_DOW転換構造型（Down終了→HL→TriggerHigh）に沿って判定再置換（モード切替復旧）
        private const string CODE_NAME = "EA_HL_DEV_010_030";
...
private DateTime? ComputeNewsUnblockUtc(DateTime utcNow)
{
    ...
    return null;
        ...
        private const string HL_OldDrawObjectPrefix_010_029 = "EA_HL_DEV_010_029.";
        private const string HL_OldDrawObjectPrefix_010_028 = "EA_HL_DEV_010_028.";
        private static readonly string[] HL_OldDrawObjectPrefixes = new[] { HL_OldDrawObjectPrefix_010_029, HL_OldDrawObjectPrefix_010_028 };
