...
// ============================================================
// BASE: EMA_M5_ALL_DAY_020_073_XAUUSD_M5
// THIS: HIVE_010_005
...
namespace cAlgo
{
    ...
    public class HIVE_010_005 : Robot
    {
        // ============================================================
        // CODE NAME (Project Constitution compliant)
        // ============================================================
        // BASE: EMA_M5_ALL_DAY_020_073_XAUUSD_M5
        // THIS: HIVE_010_005
        private const string CODE_NAME = "HIVE_010_005";
...
private void EmitExecuteSendJsonl(TradeType plannedType, int barIndex, long volumeUnits, double slPipsToSend, double tpPipsToSend)
        ...
        // {"event":"EA_INIT","code_name":"HIVE_010_005","run_id":"20260210_120000_000","symbol_raw":"XAUUSD","symbol_norm":"XAUUSD","timeframe":"Minute5","flags":{"EnableProReport":true},"params":{"RiskPercent":"0.50"}}
        // {"event":"BAR_CLOSE","code_name":"HIVE_010_005","run_id":"20260210_120000_000","symbol_norm":"XAUUSD","timeframe":"Minute5","bar_index":1234,"bar_time_utc_ms":1739145600000,"open":2910.1,"high":2912.4,"low":2909.8,"close":2911.6,"spread":2.1}
        // {"event":"EXECUTE_SKIP","code_name":"HIVE_010_005","run_id":"20260210_120000_000","symbol_norm":"XAUUSD","timeframe":"Minute5","bar_time_utc_ms":1739145600000,"plannedType":"Buy","reason":"SPREAD_BLOCK","close1":2911.6,"ema1":2911.2,"spread":3.4}
        // {"event":"EXECUTE_SEND","code_name":"HIVE_010_005","run_id":"20260210_120000_000","symbol_norm":"XAUUSD","timeframe":"Minute5","bar_time_utc_ms":1739145600000,"plannedType":"Buy","volumeUnits":1000,"slPipsToSend":35.0,"tpPipsToSend":35.0}
        // {"event":"EXECUTE_RESULT","code_name":"HIVE_010_005","run_id":"20260210_120000_000","symbol_norm":"XAUUSD","timeframe":"Minute5","bar_time_utc_ms":1739145600000,"plannedType":"Buy","success":true,"positionId":12345678,"error":null}
...
private DateTime? ComputeNewsUnblockUtc(DateTime utcNow)
{
    ...
    return null;
        ...
        private bool PassesEma10Ema20DirectionDecision(TradeType type, int i1)
        {
            ...
            double deadzonePips = InputPipsToInternalPips(Ema10Ema20EqualDeadzonePips);
...
";
        ...
        // ============================================================
        sealed class HiveComplianceController
        {
            private readonly HIVE_010_005 _bot;
            ...
            public HiveComplianceController(HIVE_010_005 bot)
            {
                _bot = bot;
            }
