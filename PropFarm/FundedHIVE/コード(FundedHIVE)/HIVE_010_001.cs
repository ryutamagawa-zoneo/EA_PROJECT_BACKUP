...
namespace cAlgo
{
    ...
    public class HIVE_010_001 : Robot
    {
        // ============================================================
        // CODE NAME (Project Constitution compliant)
        // ============================================================
        // BASE: EMA_M5_ALL_DAY_020_033_XAUUSD_M5
        // THIS: HIVE_010_001
        private const string CODE_NAME = "HIVE_010_001";
        private const string BOT_LABEL = "HIVE_010_001";
        ...
        private bool _stopLiquidationActive = false;
...
public bool TradePermission { get; private set; } = true;
        ...
        private void EnsureStopLiquidation(DateTime utcNow)
        {
            ...
            int pendingBefore = CountMyPendingOrders();
            int posBefore = CountMyPositions();
